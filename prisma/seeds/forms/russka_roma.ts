...
export const RUSSKA_ROMA_FORMS: FormSeed[] = [
  ...
  // — Живые фразы —
  { conceptSlug: "kak-tebya-zovut", dialect: Dialect.RUSSKA_ROMA, romaniWord: "Сыр тут кхарэ́н?", transcription: "сыр тут кхарэ́н", sources: ["DEMETER1990"], confidence: FormConfidence.DRAFT, notes: "буквально '(они) как тебя называют'" },
