...
export const SERVY_FORMS: FormSeed[] = [
  ...
  { conceptSlug: "bezhat",       dialect: Dialect.SERVY, romaniWord: "Te nashel",    transcription: "тэ нашэ́л",    sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "iskat",        dialect: Dialect.SERVY, romaniWord: "Te rodel",     transcription: "тэ родэ́л",    sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "nakhodit",     dialect: Dialect.SERVY, romaniWord: "Te arakhel",   transcription: "тэ аракхэ́л",  sources: ["BOR1994"],                 confidence: FormConfidence.VERIFIED },
  { conceptSlug: "brat-v-ruki",  dialect: Dialect.SERVY, romaniWord: "Te lel",       transcription: "тэ лэл",       sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "prinosit",     dialect: Dialect.SERVY, romaniWord: "Te anel",      transcription: "тэ анэ́л",     sources: ["BOR1994"],                 confidence: FormConfidence.VERIFIED },
  { conceptSlug: "posylat",      dialect: Dialect.SERVY, romaniWord: "Te bičhal",    transcription: "тэ бичха́л",   sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT },
  { conceptSlug: "otkryvat",     dialect: Dialect.SERVY, romaniWord: "Te putrel",    transcription: "тэ путрэ́л",   sources: ["BOR1994"],                 confidence: FormConfidence.VERIFIED },
  { conceptSlug: "zakryvat",     dialect: Dialect.SERVY, romaniWord: "Te phandel",   transcription: "тэ пхандэ́л",  sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "sprashivat",   dialect: Dialect.SERVY, romaniWord: "Te pučhel",    transcription: "тэ пучхэ́л",   sources: ["BOR1994"],                 confidence: FormConfidence.VERIFIED },
  { conceptSlug: "zhdat",        dialect: Dialect.SERVY, romaniWord: "Te adžukerel", transcription: "тэ аджукэрэ́л",sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT },
  { conceptSlug: "chitat",       dialect: Dialect.SERVY, romaniWord: "Te ginel",     transcription: "тэ гинэ́л",    sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "тот же корень, что 'считать' в ряде говоров" },
  { conceptSlug: "pisat",        dialect: Dialect.SERVY, romaniWord: "Te iskirinel", transcription: "тэ искиринэ́л",sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT },
  { conceptSlug: "zabyvat",      dialect: Dialect.SERVY, romaniWord: "Te bisterel",  transcription: "тэ бистэрэ́л", sources: ["BOR1994"],                 confidence: FormConfidence.VERIFIED },
  { conceptSlug: "pokazyvat",    dialect: Dialect.SERVY, romaniWord: "Te sikavel",   transcription: "тэ сикавэ́л",  sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "uchit",        dialect: Dialect.SERVY, romaniWord: "Te sikavel",   transcription: "тэ сикавэ́л",  sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.DRAFT, notes: "буквально 'показывать, обучать'" },
  { conceptSlug: "ponimat",      dialect: Dialect.SERVY, romaniWord: "Te hatjarel",  transcription: "тэ хатярэ́л",  sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "nazyvat",      dialect: Dialect.SERVY, romaniWord: "Te bušol",     transcription: "тэ бушо́л",    sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "букв. 'зваться, называться'" },
  { conceptSlug: "otvechat",     dialect: Dialect.SERVY, romaniWord: "Te odphenel",  transcription: "тэ одпхэнэ́л", sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT },
  { conceptSlug: "povtoryat",    dialect: Dialect.SERVY, romaniWord: "Te pale phenel", transcription: "тэ па́ле пхэнэ́л", sources: ["BOR1994"],              confidence: FormConfidence.DRAFT, notes: "буквально 'сказать снова'" },
  { conceptSlug: "obyasnyat",    dialect: Dialect.SERVY, romaniWord: "Te mothavel",  transcription: "тэ мотхавэ́л", sources: ["MATRAS2002"],              confidence: FormConfidence.DRAFT },
  { conceptSlug: "soglashatsya", dialect: Dialect.SERVY, romaniWord: "Te čačarel",   transcription: "тэ чачарэ́л",  sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "подтверждать как 'верное'" },
  { conceptSlug: "otkazyvatsya", dialect: Dialect.SERVY, romaniWord: "Te na kamel",  transcription: "тэ на камэ́л", sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "буквально 'не хотеть'" },
  { conceptSlug: "razreshat",    dialect: Dialect.SERVY, romaniWord: "Te mukel",     transcription: "тэ мукэ́л",    sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED, notes: "пускать, позволять" },
  { conceptSlug: "zapreshchat",  dialect: Dialect.SERVY, romaniWord: "Te na mukel",  transcription: "тэ на мукэ́л", sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "буквально 'не пускать, не позволять'" },
  { conceptSlug: "preduprezhdat",dialect: Dialect.SERVY, romaniWord: "Te anglal phenel", transcription: "тэ англа́л пхэнэ́л", sources: ["BOR1994"],           confidence: FormConfidence.DRAFT, notes: "буквально 'сказать заранее'" },
  { conceptSlug: "izvinyatsya",  dialect: Dialect.SERVY, romaniWord: "Te iertisarel pes", transcription: "тэ иэртиса́рэл пэс", sources: ["BOR1994"],         confidence: FormConfidence.DRAFT },
  { conceptSlug: "blagodarit",   dialect: Dialect.SERVY, romaniWord: "Te palikerel", transcription: "тэ паликэрэ́л", sources: ["BOR1994", "MATRAS2002"], confidence: FormConfidence.VERIFIED, notes: "формула благодарности: palikerav" },
  ...
  // — Живые фразы —
  { conceptSlug: "kak-tebya-zovut", dialect: Dialect.SERVY, romaniWord: "Sar tut bušon?", transcription: "сар тут бушо́н", sources: ["MATRAS2002"], confidence: FormConfidence.DRAFT },
  ...
  { conceptSlug: "skolko-stoit",    dialect: Dialect.SERVY, romaniWord: "Sode mol?",     transcription: "со́дэ мол",    sources: ["BOR1994"],                 confidence: FormConfidence.DRAFT, notes: "буквально 'сколько стоит'; te molel — стоить" },
  {
    ...
    notes: "вопрос о количестве/мере; в учебных материалах по сев.-центр. вариантам (Romani Chib; Stockholm Univ. severocentr) — Keci + существительное или числительное"
  },
