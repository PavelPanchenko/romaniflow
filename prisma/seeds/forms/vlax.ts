...
export const VLAX_FORMS: FormSeed[] = [
  ...
  { conceptSlug: "bezhat",       dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te našel",    transcription: "тэ нашэ́л",    sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "iskat",        dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te rodel",    transcription: "тэ родэ́л",    sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "nakhodit",     dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te arakhel",  transcription: "тэ аракхэ́л",  sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "brat-v-ruki",  dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te lel",      transcription: "тэ лэл",       sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "prinosit",     dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te anel",     transcription: "тэ анэ́л",     sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "posylat",      dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te bičhal",   transcription: "тэ бичха́л",   sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  { conceptSlug: "otkryvat",     dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te putrel",   transcription: "тэ путрэ́л",   sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "zakryvat",     dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te phandel",  transcription: "тэ пхандэ́л",  sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "sprashivat",   dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te pučhel",   transcription: "тэ пучхэ́л",   sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "zhdat",        dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te ažukerel", transcription: "тэ ажукэрэ́л", sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "vlax j-произношение" },
  { conceptSlug: "chitat",       dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te ginel",    transcription: "тэ гинэ́л",    sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "то же слово, что 'считать' в ряде контекстов" },
  { conceptSlug: "pisat",        dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te iskirinel",transcription: "тэ искиринэ́л",sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  { conceptSlug: "zabyvat",      dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te bisterel", transcription: "тэ бистэрэ́л", sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "pokazyvat",    dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te sikavel",  transcription: "тэ сикавэ́л",  sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "uchit",        dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te sikavel",  transcription: "тэ сикавэ́л",  sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "в учебном смысле 'обучать'" },
  { conceptSlug: "ponimat",      dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te hatjarel", transcription: "тэ хатярэ́л",   sources: ["BOR1994"], confidence: FormConfidence.VERIFIED },
  { conceptSlug: "nazyvat",      dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te bušol",    transcription: "тэ бушо́л",     sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "букв. 'зваться, называться'" },
  { conceptSlug: "otvechat",     dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te odphenel", transcription: "тэ одпхэнэ́л",  sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  { conceptSlug: "povtoryat",    dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te pala phenel", transcription: "тэ па́ла пхэнэ́л", sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "буквально 'сказать снова'" },
  { conceptSlug: "obyasnyat",    dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te mothavel", transcription: "тэ мотхавэ́л",  sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  { conceptSlug: "soglashatsya", dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te čačarel",  transcription: "тэ чачарэ́л",   sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "подтверждать как 'верное'" },
  { conceptSlug: "otkazyvatsya", dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te či kamel", transcription: "тэ чи камэ́л",  sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "vlax-отрицание 'či'" },
  { conceptSlug: "razreshat",    dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te mukel",    transcription: "тэ мукэ́л",     sources: ["BOR1994"], confidence: FormConfidence.VERIFIED, notes: "пускать, позволять" },
  { conceptSlug: "zapreshchat",  dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te či mukel", transcription: "тэ чи мукэ́л",  sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "буквально 'не позволять'" },
  { conceptSlug: "preduprezhdat",dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te anglal phenel", transcription: "тэ англа́л пхэнэ́л", sources: ["BOR1994"], confidence: FormConfidence.DRAFT, notes: "буквально 'сказать заранее'" },
  { conceptSlug: "izvinyatsya",  dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te iertisarel pes", transcription: "тэ иэртиса́рэл пэс", sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  { conceptSlug: "blagodarit",   dialect: Dialect.VLAX_KALDERASH, romaniWord: "Te palikerel", transcription: "тэ паликэрэ́л", sources: ["BOR1994"], confidence: FormConfidence.VERIFIED, notes: "формула благодарности: palikerav" },
  ...
  { conceptSlug: "skolko-stoit",    dialect: Dialect.VLAX_KALDERASH, romaniWord: "Sode mol?",    transcription: "со́дэ мол",    sources: ["BOR1994"], confidence: FormConfidence.DRAFT },
  {
    ...
    notes: "интеррогатив количества; в реконструкции Early Romani и обзорах Manchester Romani Project — keti 'how much/many'"
  },
